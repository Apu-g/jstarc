            ...
            <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
                    ...
                    <div className="relative h-80 w-full">
                        <AnimatePresence>
                            {testimonials.map((testimonial, index) => (
                                <motion.div
                                    key={testimonial.src || index} // Use index fallback if src is duplicated or missing
                                    initial={{
                                        opacity: 0,
                                        scale: 0.9,
                                        z: -100,
                ...
                <div className="flex flex-col justify-between py-4">
                    ...
                    <div className="flex gap-4 pt-12 md:pt-0">
                        <button
                            onClick={handlePrev}
                            className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-colors">
                            <IconArrowLeft
